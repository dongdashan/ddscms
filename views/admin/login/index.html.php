...
<head>
    ...
    <title>登陆_后台管理</title>
    <link rel="stylesheet" href="<?php echo $wconfig['public_path']; ?>/bootstrap-3.3.7/css/bootstrap.min.css"/>
    <link rel="stylesheet" href="<?php echo $wconfig['theme_admin']; ?>/css/global.css"/>
    <link rel="stylesheet" href="<?php echo $wconfig['theme_admin']; ?>/css/admin-login.css"/>
    <script>
        // 让登陆页不在框架(iframe)里显示
    ...
    <script src="<?php echo $wconfig['public_path']; ?>/js/bootstrap-3.3.7/bootstrap.min.js"></script>
...
<div class="container">
    <form method="post" action="?m=login&a=login" id="w-form-login" autocomplete="off">
        <h2 class="w-form-login-title"> 后台</h2>
