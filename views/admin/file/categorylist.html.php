...
<html>
    <head>
        <?php include $wconfig['theme_path'] . '/admin/head.inc.php';echo admin_head('附件分类列表');?>
    </head>
    <body>
        <?php include $wconfig['theme_path'] . '/admin/header.html.php';?>
            <h4 class="w-h4">附件分类列表</h4>
                    ...
                    <tbody>
                        ...
                        foreach($categories as $v) {
                            ...
                            echo '<tr>' .
                                ...
                                '<td>'. $status_str .'</td>' .
                                '<td>' .
                                    '<a class="btn btn-success btn-xs w-a-btn" href="?m=file&a=categoryupdate&cid='. $v['cid'] .'">更新</a>' .
                                    ' - <a class="btn btn-danger btn-xs w-a-btn w-delete" href="?m=file&a=categorydelete&cid='. $v['cid'] .'&formtoken='. $wuser->formtoken .'">删除</a>' .
                                '</td>' .
                            '</tr>';
                        }
                        ?>
