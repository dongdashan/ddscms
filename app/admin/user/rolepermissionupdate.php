...
$role = $wdb->get("{$wconfig['db']['tablepre']}role","roleid","rolename",array("roleid"=>$roleid));
if( empty($role) ) {
...
$sql_u=$wdb->update("{$wconfig['db']['tablepre']}role",array("permission"=>$permission_str),array("roleid"=>$roleid));
if( $sql_u ) {
