...
// 系统配置
$wconfig['error_reporting'] = true;
$wconfig['version']         = 'wcms1.0';
$wconfig['timezone']        = 'Asia/Hong_Kong';
$wconfig['protocol']        = 'http';
$wconfig['lang']            = 'zh_cn';
$wconfig['theme']           = 'default';
$wconfig['authkey']         = 'wYv53XFeiUSrfVdC';
...
// 数据库配置
$wconfig['db']             = array();
$wconfig['db']['host']     = '127.0.0.1';
$wconfig['db']['username'] = 'root';
$wconfig['db']['password'] = 'root';
$wconfig['db']['name']     = 'wzda';
