...
// 调试工具
// include W_ROOT_PATH .'/lib/kint.php';
//include W_ROOT_PATH .'/lib/php_error.php';
...
// 定义模板路径
$wconfig['theme_path'] = W_ROOT_PATH . '/views';
$wconfig['theme_skin'] = $wconfig['public_path'] . '/theme/' . $wconfig['theme'];

$wconfig['theme_admin'] =  'views/admin';
$wconfig['theme_pc'] =     'views/pc/' . $wconfig['theme'].'/content';
$wconfig['theme_mobile'] = 'views/mobile/' . $wconfig['theme'];
...
require W_ROOT_PATH .'/lib/medoo.1.1.3.php';
$config_db=array(
    'database_type' => 'mysql',
    'charset' => 'utf8',
    'server' => '127.0.0.1',
