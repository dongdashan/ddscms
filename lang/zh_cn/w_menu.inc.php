...
$wmenu['admin/file']                    = array('name'=>'附件管理', 'display'=>1);
$wmenu['admin/file/categoryadd']        = array('name'=>'附件分类添加', 'display'=>1);
$wmenu['admin/file/categorylist']       = array('name'=>'附件分类列表', 'display'=>1);
$wmenu['admin/file/categoryupdate']     = array('name'=>'附件分类更新', 'display'=>0);
$wmenu['admin/file/categorydelete']     = array('name'=>'附件分类删除', 'display'=>0);
$wmenu['admin/file/add']                = array('name'=>'附件添加', 'display'=>1);
$wmenu['admin/file/list']               = array('name'=>'附件列表', 'display'=>1);
$wmenu['admin/file/update']             = array('name'=>'附件更新', 'display'=>0);
$wmenu['admin/file/delete']             = array('name'=>'附件删除', 'display'=>0);

$wmenu['admin/model']                    = array('name'=>'模型管理', 'display'=>1);
$wmenu['admin/model/add']                = array('name'=>'模型添加', 'display'=>1);
$wmenu['admin/model/list']               = array('name'=>'模型列表', 'display'=>1);
$wmenu['admin/model/update']             = array('name'=>'模型更新', 'display'=>0);
$wmenu['admin/model/delete']             = array('name'=>'模型删除', 'display'=>0);
$wmenu['admin/model/disabled']             = array('name'=>'模型禁用', 'display'=>0);
$wmenu['admin/model/fieldlist']             = array('name'=>'字段列表', 'display'=>0);
$wmenu['admin/model/fieldadd']             = array('name'=>'字段添加', 'display'=>0);
$wmenu['admin/model/fieldupdate']             = array('name'=>'字段修改', 'display'=>0);
$wmenu['admin/model/fielddelete']             = array('name'=>'字段删除', 'display'=>0);
$wmenu['admin/model/fielddisabled']             = array('name'=>'字段禁用', 'display'=>0);
